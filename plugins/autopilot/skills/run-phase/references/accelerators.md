...
are *force multipliers*, never prerequisites — the baseline (focused subagents + `/code-review` +
...
Tier 2. The gate's pass/fail meaning is identical — accelerators change *how thoroughly and how fast*
you reach the verdict, never *whether a red gate can advance*.
