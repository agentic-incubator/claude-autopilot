...
How a feature goes from spec to merged, and exactly where ruflo / agentic-qe (aqe) plug in **only when
detected**. Everything works without them; when present, autopilot actively drives them.
